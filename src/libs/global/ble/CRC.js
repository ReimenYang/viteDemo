...
CRC.CRC16 = function (buffer, type = 'str') {
  let hi = 0xFF
  let lo = 0xFF
  ...
  console.log('高位在左低位在右，使用时请注意！！校验计算结果', CRC.padLeft((hi << 8 | lo).toString(16).toUpperCase(), 4, '0'))
  switch (type) {
    case 'str':
    ...
    case 'arr':
      return [hi, lo]
    case 'buffer':
      dataView.setUint8(0, hi)
      dataView.setUint8(1, lo)
